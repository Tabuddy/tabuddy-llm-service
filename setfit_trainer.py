...
TIER2_DIGITAL_DATA = [
    ...
    {"text": "Data Engineer building real-time streaming pipelines with Kafka and Flink.", "label": "Data_Intelligence"},
    {"text": "Data Engineer implementing knowledge graphs using Neo4j and SPARQL.", "label": "Data_Intelligence"},
    {"text": "Data Engineer developing ETL workflows with dbt and Airflow.", "label": "Data_Intelligence"},
    {"text": "Data Engineer constructing data lakehouse with Delta Lake and Databricks.", "label": "Data_Intelligence"},
    {"text": "Data Engineer preparing embeddings for vector search using OpenAI and Pinecone.", "label": "Data_Intelligence"},
    {"text": "Data Engineer managing HDFS clusters and YARN resource allocation.", "label": "Data_Intelligence"},
    {"text": "Data Pipeline Engineer designing batch processing systems with Luigi.", "label": "Data_Intelligence"},
    {"text": "Graph Data Specialist implementing RDF triple stores and SPARQL endpoints.", "label": "Data_Intelligence"},
    {"text": "Data Engineer optimizing data transformations using Spark and Scala.", "label": "Data_Intelligence"},
    {"text": "Data Engineer ingesting data from cloud storage (S3, Azure Blob) into warehouses.", "label": "Data_Intelligence"},
    {"text": "ML Engineer feature engineering and storing features in Feast feature store.", "label": "Data_Intelligence"},
    {"text": "Data Engineer orchestrating workflows with Kubeflow and Argo.", "label": "Data_Intelligence"},
    {"text": "Data Engineer building data ingestion pipelines from APIs and streaming sources.", "label": "Data_Intelligence"},
    {"text": "Data Engineer ensuring data quality and governance with Great Expectations.", "label": "Data_Intelligence"},
    # Infra_Cloud
    ...
    {"text": "Cloud Security Engineer implementing VPC endpoint policies and encryption key management.", "label": "Infra_Cloud"},
    {"text": "Edge Infrastructure Engineer deploying and managing low-latency nodes for content delivery.", "label": "Infra_Cloud"},
    {"text": "SRE automating runbooks and post-mortem processes to reduce MTTR.", "label": "Infra_Cloud"},
    {"text": "Observability Engineer designing centralized logging and distributed tracing systems.", "label": "Infra_Cloud"},
    {"text": "Capacity Planner forecasting resource needs and auto-scaling strategies.", "label": "Infra_Cloud"},
    {"text": "Disaster Recovery Engineer designing multi-site failover and backup retention policies.", "label": "Infra_Cloud"},
    # Product_Design
